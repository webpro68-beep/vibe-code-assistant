...
from sqlalchemy import String, Text, Boolean, Integer, DateTime, ForeignKey, Numeric, JSON
...
class StyleTemplate(Base):
    ...
    prompt_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    ...
    voice_profile_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    thumbnail_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
...
class NarrativeTemplate(Base):
    ...
    structure_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    slot_schema_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    cta_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
...
class SceneBlueprint(Base):
    ...
    blueprint_json: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    timeline_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
...
class CharacterPack(Base):
    ...
    appearance_lock_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    reference_assets_json: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    pose_variants_json: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    expression_variants_json: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    usage_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
...
class ThumbnailTemplate(Base):
    ...
    headline_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    crop_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
...
class PublishingTemplate(Base):
    ...
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
    publishing_rules_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    ...
    hashtags_json: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    upload_defaults_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=datetime.utcnow)
...
class TemplateExtraction(Base):
    ...
    extraction_report_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
...
class TemplateUsageRun(Base):
    ...
    input_slots_json: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    status: Mapped[str] = mapped_column(Text, nullable=False, default="queued")
